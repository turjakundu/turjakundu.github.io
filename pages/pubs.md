...
International bridge card game that can be played on LAN

 

LAN audio video conferencing
	

Software
	

Java (Java network programming, Java Media Framework API)
	

Netbeans (Windows)
	

LAN audio video conferencing software with chatting facility implemented by java socket programming.
...
An artificial DOS implemented through 8086 Assembly language 
...
A web based hotel management system with maintenance facility of the remote branches.
...
Information systems/ System design &  Documentation
...
Inventory management solution for a corporate with a reference to TIENS, Bangladesh. A management system with admin, sales, store and accounts subsystems.
...
A pascal compiler with error identification systems implemented by Context free grammar to convert a pascal program to machine dependent assembly language.

Virtual network layer simulation
...
A virtual network layer implemented by java multithreaded programming with ‘ping’ and ‘tracert’ facilities 
...
An index server with the facility to upload, share, search and delete files in a network. 
...
JSP, java Spring framework, mySQL
	

Windows
	

A third party web based hotel reservation system that facilitates the searching and reservation of hotels 
...
A microprocessor based traffic control system.

An artificial operating system
...
An artificial operating system implemented with NACHOS environment. The system supports multithreading, multiprogramming,  resource management, file systems ,process management and inter process communication 

6-bit signed binary multiplier
...
a binary multiplier that multiplies 2 six bit binary numbers 
...
A 4-bit microprocessor with 28 instructions

Mega structure Modeling of Burj-Al-Arab
...
A 3D modelling of Burj-Al-Arab (A hotel of Dubai)
